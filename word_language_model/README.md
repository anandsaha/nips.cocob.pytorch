For the word prediction test, I used the below example from PyTorch examples. I modified the main.py file to make it loop through and test the various optimizers. You can see the change by diffing main.py and main.orig.py.

The following command was run to generate the results:


```
python3 main.py --cuda --data data/penn_ds/ --model LSTM --epochs 40
```

The results were dumped in a pickle file called `../result_4.pkl`, which was plotted using the `../plot.word.prediction.pbt.ipynb` notebook.

**Here is the original readme from [https://github.com/pytorch/examples/tree/master/word_language_model](https://github.com/pytorch/examples/tree/master/word_language_model):**
